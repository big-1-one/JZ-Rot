...
import { Data } from '../src/core/data.ts';
import { RotX } from '../src/core/rotx.ts';
...
const _input = "Hello, World! 123";
const _encoded = _rot.encode(_input, { /* rot: 7,  */base64: false });
const _decoded = _rot.decode(_encoded ?? "", { /* rot: 7,  */base64: false });
